<template>
  <nav class="navbar">
    ...
    <div class="navbar-right">
      ...
      <!-- Panel del usuario si está logueado -->
...
<script>
import authService from "../controlador/authService"; // Servicio de autenticación
...
export default {
  data() {
    return {
      ...
      username: "",
      password: "",
      userRole: "guest", // guest, estudiante, docente, admin
    };
  },
  methods: {
    isActive(route) {
